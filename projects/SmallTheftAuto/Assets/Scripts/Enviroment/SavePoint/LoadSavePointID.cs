...
public class LoadSavePointID : MonoBehaviour
{
    ...
    void PlacePlayer()
    {
        ...
        var savePointsID = FindObjectsOfType<SavePointID>().ToList();
        var found = savePointsID.Find(x => x.Id == savePointIdToFind);
